...
For Each d In dc
    ...
    End Select
Next
ListView2.ListItems.Add , "CONFIGWINUX", "Configuration de WINUX", "IMAGE6"
ListView2.ListItems.Add , "INFOSWINUX", "Informations sur WINUX", "IMAGE5"
End Sub
...
s = s & "Nom de volume : " & dc.VolumeName & vbCrLf & vbCrLf
s = s & "N° de serie : " & dc.SerialNumber & vbCrLf
s = s & "Système de fichier : " & dc.FileSystem & vbCrLf
s = s & "Taille : " & Round(dc.TotalSize / 1024 / 1024, 2) & " Mo." & vbCrLf
s = s & "Espace libre : " & Round(dc.FreeSpace / 1024 / 1024, 2) & " Mo. "
s = s & vbCrLf
Label1.Caption = s
End Sub
...
Exit Sub
Perif: MsgBox "Périphérique non disponible ! Veuillez insérer un disque et recommencer."
End Sub
